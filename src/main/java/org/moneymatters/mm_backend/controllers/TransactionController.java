...
public class TransactionController {
    ...
    public ResponseEntity<?> addTransaction(@RequestBody @Valid TransactionDTO transactionDTO) {
        ...
        if  (transactionDTO.getBudgetId() != null) {
            Optional<Budget> budgetOptional = budgetRepository.findById(transactionDTO.getBudgetId());
        ...
        if (transactionDTO.getTagId() != null) {
            Optional<Tag> tagOptional = tagRepository.findById(transactionDTO.getTagId());
